...
def vgg(arch, device="cpu", ckpt_path=None, **kwargs):
    if ckpt_path:
        kwargs["init_weights"] = False
    model = VGG(make_layers(cfgs[arch], batch_norm=True), **kwargs)
    if ckpt_path:
...
def test():
    ckpt_path = "/data0/hli/data/cifar10-pretrained/"
    net = vgg("vgg16_bn", ckpt_path)
